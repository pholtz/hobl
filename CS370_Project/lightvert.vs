				...
				inout vec4 specular)
{
	...
	// TODO: Compute vector from surface to light position
	VP = vec3(gl_LightSource[i].position) - ecPosition3;
	
	// TODO: Compute distance between surface and light position
	d = length(VP);
	
	// TODO: Normalize the vector from surface to light position
	VP = normalize(VP);
				...
				inout vec4 specular)
{
	...
	// TODO: Check if point on surface is inside cone of illumination
	...
	// TODO: Combine the spotlight and distance attenuation
